...
public class TestData {
    ...
    public static TestDatum[] test_data = {
    	...
    	/*54*/new TestDatum( "a b c ab ac bc", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.104022409444124E7),
    	...
    	/*135*/new TestDatum( "a b c ab ac bc", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.104022409444124E7),
    	...
    	/*144*/new TestDatum( "a b ab c ac bc abc d ad bd abd cd acd bcd abcd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.3336268218680264E8),
    	...
    	/*147*/new TestDatum( "a b ab c ac bc abc cd acd bcd abcd cde acde bcde abcde", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 3.452248363703656E8),
    	/*148*/new TestDatum( "a b ab c ac bc abc cd acd bcd abcd cde acde bcde abcde", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 2.382084339699228E8),
    	/*149*/new TestDatum( "a b ab c ac bc abc cd acd bcd abcd cde acde bcde abcde", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 2.0452239075511503E8),
    	/*150*/new TestDatum( "a b ab c ac bc abc d ad bd abd cd acd bcd abcd cde acde bcde abcde", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 5.3094562399390626E8),
    	/*151*/new TestDatum( "a b ab c ac bc abc d ad bd abd cd acd bcd abcd cde acde bcde abcde", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 3.471449709099385E8),
    	...
    	/*153*/new TestDatum( "abcd abce", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 6.712753619023192E7),
    	/*154*/new TestDatum( "abcd abce", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 6.712753619023192E7),
    	/*155*/new TestDatum( "abcd abce", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 6.712753619023192E7),
    	...
    	/*165*/new TestDatum( "abcd abce de", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.2775952620850746E8),
    	/*166*/new TestDatum( "abcd abce de", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 1.1604702327475764E8),
    	/*167*/new TestDatum( "abcd abce de", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 1.1604702327475764E8),
    	/*168*/new TestDatum( "a b ab c ac bc abc df adf bdf abdf cd acd bcd abcd cde acde bcde abcde", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.182656020041429E9),
    	/*169*/new TestDatum( "a b ab c ac bc abc df adf bdf abdf cd acd bcd abcd cde acde bcde abcde", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 7.709434585085269E8),
    	...
    	/*171*/new TestDatum( "abd abc dc", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 3.648094438721426E7),
    	/*172*/new TestDatum( "abd abc dc", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 3.2271082167664733E7),
    	/*173*/new TestDatum( "abd abc dc", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 3.2271082167664733E7),
    	/*174*/new TestDatum( "a b ab c ac bc abc p q pq r pr qr pqr x bx px", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 4.1017093888011616E8),
    	/*175*/new TestDatum( "a b ab c ac bc abc p q pq r pr qr pqr x bx px", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 2.9408551128216606E8),
    	...
    	/*180*/new TestDatum( "a b c d cd ae be e ce de cde", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.2427224621713138E8),
    	...
    	/*183*/new TestDatum( "a b c d cd ae be e ce de cde ef", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 2.151210279767573E8),
    	...
    	/*189*/new TestDatum( "a b c ab ac bc abc abd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 5.434253748019025E7),
    	...
    	/*192*/new TestDatum( "a b c ab ac bc abc abcd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 6.051736890770621E7),
    	...
    	/*195*/new TestDatum( "ad bd cd abd acd bcd abcd d", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 4.817485346354427E7),
    	/*196*/new TestDatum( "ad bd cd abd acd bcd abcd d", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 4.055857080444325E7),
    	...
    	/*198*/new TestDatum( "a b c ab ac bc abc ad bd cd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 6.0028199629417576E7),
    	/*199*/new TestDatum( "a b c ab ac bc abc ad bd cd", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 4.503468127184408E7),
    	...
    	/*201*/new TestDatum( "a b c ab ac bc abc abd bcd acd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 7.351977186923073E7),
    	/*202*/new TestDatum( "a b c ab ac bc abc abd bcd acd", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 5.5052669570643194E7),
    	...
    	/*204*/new TestDatum( "a b c ab ac bc abc ad d", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 5.2565681111037165E7),
    	...
    	/*207*/new TestDatum( "a b c ab ac bc abc ad abd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 5.939674688711681E7),
    	...
    	/*209*/new TestDatum( "a b c ab ac bc abc ad abd", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 4.045948805003159E7),
    	/*210*/new TestDatum( "a b c ab ac bc abc abd abcd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 7.024675860398512E7),
    	...
    	/*213*/new TestDatum( "a b c ab ac bc abc ad d be e cf f", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.9921501784056205E8),
    	...
    	/*216*/new TestDatum( "a b c ab ac bc abc ad bd abd d", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 6.175594473885106E7),
    	...
    	/*219*/new TestDatum( "a b c ab ac bc abc acd bcd abcd cd", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 8.738880567312913E7),
    	...
    	/*222*/new TestDatum( "a ab b ac c ad d be e cf f dg g", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.7540422398257038E8),
    	...
    	/*225*/new TestDatum( "a ab b ac c ad d be e cf f dg g eh h fi i gj j ak k kl l lm m", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.9857216204266558E9),
    	...
    	/*228*/new TestDatum( "ab ac abc ad ae ade", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 5.292083514596908E7),
    	/*229*/new TestDatum( "ab ac abc ad ae ade", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 4.755588124679146E7),
    	/*230*/new TestDatum( "ab ac abc ad ae ade", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 4.755588124679146E7),
    	...
    	/*234*/new TestDatum( "a b ab c ac d ad be ce de", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 6.810940707324508E7),
    	/*235*/new TestDatum( "a b ab c ac d ad be ce de", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 5.680148620877832E7),
    	/*236*/new TestDatum( "a b ab c ac d ad be ce de", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 5.680148620877832E7),
    	/*237*/new TestDatum( "a b ab c ac d ad ae be ce de", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.0086996633291946E8),
    	/*238*/new TestDatum( "a b ab c ac d ad ae be ce de", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 7.877849119852631E7),
    	/*239*/new TestDatum( "a b ab c ac d ad ae be ce de", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 7.877849119852631E7),
    	/*240*/new TestDatum( "a b ab c ac abd ace acef acefg", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 2.9850645579635805E8),
    	/*241*/new TestDatum( "a b ab c ac abd ace acef acefg", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 2.4280043425589928E8),
    	/*242*/new TestDatum( "a b ab c ac abd ace acef acefg", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 2.4280043425589928E8),
    	/*243*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.202658086042053E9),
    	/*244*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 1.0033785786523244E9),
    	/*245*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 1.0033785786523244E9),
    	/*246*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.8235442478854792E9),
    	/*247*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 1.4078071264311068E9),
    	/*248*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 1.4078071264311068E9),
    	/*249*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 2.3929930026336737E9),
    	/*250*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 1.8563542279691625E9),
    	/*251*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 1.8563542279691625E9),
    	/*252*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 3.0224625427597456E9),
    	/*253*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 2.3554469599580116E9),
    	/*254*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 2.3554469599580116E9),
    	/*255*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 3.1401983814113245E9),
    	/*256*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 2.409440473737554E9),
    	/*257*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 2.409440473737554E9),
    	/*258*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc al", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 3.4366996101033864E9),
    	/*259*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc al", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 2.646696934826007E9),
    	/*260*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc al", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 2.646696934826007E9),
    	/*261*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc al m mn nc bc bco bo boj bp bop cq cqb rs ra s", DecompositionType.PIERCED_FIRST, RecompositionType.NESTED, 1.6129721731517231E10),
    	/*262*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc al m mn nc bc bco bo boj bp bop cq cqb rs ra s", DecompositionType.PIERCED_FIRST, RecompositionType.SINGLY_PIERCED, 1.2204805243033503E10),
    	/*263*/new TestDatum( "qh h fh ih ik kh b ab ac de bd  abc bfg fc bj l lc al m mn nc bc bco bo boj bp bop cq cqb rs ra s", DecompositionType.PIERCED_FIRST, RecompositionType.DOUBLY_PIERCED, 1.16322699355516E10),
